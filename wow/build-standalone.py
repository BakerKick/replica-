...
used = sorted(set(re.findall(r'assets/img/([\w.-]+\.(?:jpg|png))',
                            html + style + enhance + js + splash_css + splash_js + wow_css + wow_js + kb_css + kb_js)))
...
leftover = re.findall(r'assets/img/[\w.-]+', html + style + enhance + js + wow_css + wow_js + kb_css + kb_js)
